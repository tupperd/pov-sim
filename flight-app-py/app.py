...
logger = logging.getLogger("flight.app.py.logger")
...
def home():
    ...
    with tracer.start_as_current_span("davidsCustomSpan") as span:
      ...
      labels = {"service_name": "flight-app-py"}
      logger.info("Just letting you know you hit the home endpoint just fine", extra={"labels": labels})
